...
This is an *Inno Setup* script **`HashmonkeyCoin.iss`** plus related files
...
As the setup script in **`HashmonkeyCoin.iss`** has to list many
...
4. Start Inno Setup, load **`HashmonkeyCoin.iss`** and compile it
