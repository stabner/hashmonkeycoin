; HashmonkeyCoin GUI Wallet Installer for Windows
; Copyright (c) 2017-2024, The Monero Project
; See LICENSE
#define GuiVersion GetFileVersion("bin\hashmonkey-wallet-gui.exe")

[Setup]
AppName=HashmonkeyCoin Wallet
...
DefaultDirName={commonpf}\HashmonkeyCoin Wallet
DefaultGroupName=HashmonkeyCoin Wallet
UninstallDisplayIcon={app}\hashmonkey-wallet-gui.exe
...
LicenseFile=LICENSE
AppPublisher=The HashmonkeyCoin Project
AppPublisherURL=https://github.com/stabner/hashmonkeycoin
TimeStampsInUTC=yes
...
; Background info:
; This installer indeed asks for admin rights so the HashmonkeyCoin files can be copied to a place where they have at least
...
; applications somehow. Luckily this is no issue here because ALL files are "private" to HashmonkeyCoin.

Source: {#file AddBackslash(SourcePath) + "ReadMe.htm"}; DestDir: "{app}"; DestName: "ReadMe.htm"; Flags: ignoreversion
Source: "FinishImage.bmp"; Flags: dontcopy
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion

; HashmonkeyCoin Wallet exe and guide
Source: "bin\hashmonkey-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\monero-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; HashmonkeyCoin CLI wallet
Source: "bin\extras\hashmonkey-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; HashmonkeyCoin wallet RPC interface implementation
Source: "bin\extras\hashmonkey-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; HashmonkeyCoin daemon
Source: "bin\hashmonkeyd.exe"; DestDir: "{app}"; Flags: ignoreversion

; HashmonkeyCoin daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "hashmonkeyd.bat"; DestDir: "{app}"; Flags: ignoreversion;

; HashmonkeyCoin blockchain utilities
Source: "bin\extras\hashmonkey-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\hashmonkey-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Type: filesandordirs; Name: "{localappdata}\hashmonkey-core\\p2pool"
...
; Filename: "{app}\hashmonkey-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
begin
  ...
  s := 'The default folder to store the HashmonkeyCoin blockchain is ' + blockChainDefaultDir;
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\\hashmonkeycoin\\hashmonkey-core', 'blockchainDataDir', blockChainDir);
...
begin
  if CurStep = ssPostInstall then begin
    // Re-build "hashmonkeyd.bat" according to actual install and blockchain directory used
    SetArrayLength(s, 3);
    s[0] := 'REM Execute the HashmonkeyCoin daemon and then stay with window open after it exits';
    s[1] := '"' + ExpandConstant('{app}\hashmonkeyd.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
    SaveStringsToFile(ExpandConstant('{app}\hashmonkeyd.bat'), s, false); 
  end;
end;
...
[Icons]
; Icons in the "HashmonkeyCoin Wallet" program group
; Windows will almost always display icons in alphabetical order, per level, so specify the text accordingly
Name: "{group}\GUI Wallet"; Filename: "{app}\hashmonkey-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\monero-gui-wallet-guide.pdf"; IconFilename: "{app}\hashmonkey-wallet-gui.exe"
...
Name: "{group}\Utilities\HashmonkeyCoin daemon"; Filename: "{app}\hashmonkeyd.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\hashmonkey-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Name: "{group}\Utilities\x (Try Daemon, Exit Confirm)"; Filename: "{app}\hashmonkeyd.bat"
Name: "{group}\Utilities\x (Try GUI Wallet Low Graphics Mode)"; Filename: "{app}\start-low-graphics-mode.bat"
Name: "{group}\Utilities\x (Try Kill Daemon)"; Filename: "Taskkill.exe"; Parameters: "/IM hashmonkeyd.exe /T /F"

; Desktop icons, optional with the help of the "Task" section
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\hashmonkey-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\\hashmonkeycoin\\hashmonkey-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\\hashmonkeycoin\\hashmonkey-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
...
Root: HKCR; Subkey: "monero\DefaultIcon"; ValueType: "string"; ValueData: "{app}\hashmonkey-wallet-gui.exe,0"
Root: HKCR; Subkey: "monero\shell\open\command"; ValueType: "string"; ValueData: """{app}\hashmonkey-wallet-gui.exe"" ""%1"""
...
Root: HKCR; Subkey: "moneroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\hashmonkey-wallet-gui.exe,0"
Root: HKCR; Subkey: "moneroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\hashmonkey-wallet-gui.exe"" ""%1"""
